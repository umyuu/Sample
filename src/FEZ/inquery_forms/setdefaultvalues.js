...
const AREA = [
    ...
    { text:'ラナス城跡'}, { text:'ワーグノスの地'}, { text:'ザーク古戦場跡'}, { text:'ソーン平原'}, { text:'ヘイムダル高地'},
    { text:'ワードノール平原'}, { text:'アシロマ山麓'}, { text:'クローディア水源'}, { text:'スピカ隕石跡'}, { text:'始まりの大地'},
    { text:'カペラ隕石跡'}, { text:'マスクス水源'}, { text:'セノビア荒地'}, { text:'タマライア水源'}, { text:'デスパイア山麓'},
    { text:'キンカッシュ古戦場跡'}, { text:'オリオン廃街'}, { text:'ゴブリンフォーク'}, { text:'ニコナ街道'}, { text:'ログマール古戦場跡'},
    { text:'レイクパス荒地'}, { text:'ラインレイ渓谷'}, { text:'シディット水域'}, { text:'ウェンズデイ古戦場跡'}, { text:'ジャコル丘陵'},
    { text:'ブローデン古戦場跡'}, { text:'ロザリオ高地'}, { text:'オブシディアン荒地'},
];
// call function 
